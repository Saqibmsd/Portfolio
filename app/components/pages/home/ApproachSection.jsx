...
const ApproachSection = () => {
  ...
  return (
    ...
    <section className="bg-[#0a0a0a] text-white py-16 md:py-24 px-6">
      {/* Header Area */}
      <div className="max-w-[1450px] mx-auto flex flex-col md:flex-row justify-between items-start gap-8 mb-12 md:mb-16">
        ...
        {approaches.map((item, index) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-xs md:text-base max-w-xs">{item.description}</p>
            </div>
          </div>
        ))}
      </div>
