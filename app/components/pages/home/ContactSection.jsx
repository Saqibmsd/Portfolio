...
const ContactSection = () => {
  return (
    ...
    <section className="bg-[#0a0a0a] text-white relative w-full min-h-[700px] md:min-h-[900px] overflow-hidden -mt-24 md:-mt-32 pt-32 md:pt-48 pb-20 z-10 px-6">
      <div className="max-w-[1450px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="bg-[#111111] p-6 md:p-6 xl:p-10 rounded-3xl md:rounded-[2.5rem] border border-white/5">
          <form className="space-y-4">
            {/* CHANGE: Form inputs now stack on small mobile but go side-by-side on md breakpoint */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="space-y-1">
                <label className="text-[10px] md:text-xs uppercase tracking-widest text-gray-500 ml-1">First Name</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1">
                <label className="text-[10px] md:text-xs uppercase tracking-widest text-gray-500 ml-1">Last Name</label>
                <input 
                  type="text" 
                  placeholder="Saqib" 
                  className="w-full bg-[#1a1a1a] border-none rounded-xl md:rounded-2xl py-3 px-4 lg:py-1 lg:px-4 text-white placeholder:text-gray-700 focus:ring-2 focus:ring-[#ff5c00] outline-none transition-all"
