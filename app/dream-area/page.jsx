...
const Hero = () => {
  ...
  const resultImages = [
    "https://cdn.prod.website-files.com/68b3d5ef92d2b3414ccebad2/68bd344761e6d38a4f49f9c0_3.avif",
    "https://cdn.prod.website-files.com/68b3d5ef92d2b3414ccebad2/68bd3449f9a2b1e10b450ba1_4.avif",
    "https://cdn.prod.website-files.com/68b3d5ef92d2b3414ccebad2/68bd344cc4bd64cabae4a606_5.avif",
    "https://cdn.prod.website-files.com/68b3d5ef92d2b3414ccebad2/68bd344eb354943c23958875_6.avif",
  ];
  ...
  const phrases = ["Dream Area", "Vision Studio"];
    ...
    <div className="w-full overflow-hidden flex flex-col min-h-screen bg-black">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-12 mb-8 md:mb-16">
              ...
              <div className="flex-1 max-w-sm text-start">
                ...
                <p className="text-white/50 text-base md:text-sm lg:text-lg leading-relaxed">
                  Crafting thoughtful experiences from powerful ideas.
                </p>
              </div>
            </div>
      ...
      <section className="w-full text-white py-24 px-4 md:px-10">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          >
            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-md">
              This visual composition features smooth, flowing forms blended
              with vibrant gradients of blue, purple, pink, and orange, creating
              a modern and immersive digital art experience.
            </p>
          </motion.div>
          ...
          >
            <p>
              This artwork presents a dynamic collection of fluid, ribbon-like
              shapes layered in shimmering colors. The seamless movement and
              balanced composition reflect creativity, innovation, and attention
              to detail, delivering a visually captivating experience.
            </p>
            <p>
              The main challenge was to design a visually appealing composition
              that maintained balance, depth, and harmony while preserving a
              clean and minimal background. Achieving smooth transitions,
              realistic textures, and strong visual impact required careful
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-4">
          ...
          >
            <p>
              Through detailed experimentation with colors, lighting, and
              motion, this design was developed to enhance visual flow and
              create a sense of movement. Each element was carefully positioned
              to ensure consistency, elegance, and visual clarity.
            </p>
            <p>
              The goal was to create a visually striking and engaging design
              that communicates creativity, professionalism, and modern
              aesthetics while delivering a memorable user experience.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="w-full py-24 px-4 md:px-10 text-white">
        <div className="max-w-[1400px] mx-auto space-y-14">
          ...
          >
            <img
              src="https://cdn.prod.website-files.com/68b3d5ef92d2b3414ccebad2/68bd3443f1c5d4f164a34e60_2.avif"
              alt="Product"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            >
              The final outcome is a visually compelling and high-performing
              digital design that enhances brand presence, improves user
              engagement, and strengthens online visibility. The project
              successfully increased audience interaction and received positive
              feedback for its creativity and usability.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            >
              <p className="text-white/80 leading-relaxed text-sm md:text-[15px] lg:text-lg">
                Our team created a custom website design that is visually
                stunning, user-friendly, and optimized for search engines. The
                client's site now professionally showcases their products and
                services, resulting in significant increases in organic traffic
                and customer engagement. The client is thrilled with the outcome
                and has received positive feedback from customers.
              </p>
            </motion.div>
          </div>
        </div>
